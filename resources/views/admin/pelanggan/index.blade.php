                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <select name="gender" class="form-select"
                                        onchange="if(this.value===''){ window.location='{{ route('pelanggan.index') }}'; } else { this.form.submit(); }">
                                ...
                                <tbody>
                                    @forelse ($dataPelanggan as $pelanggan)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $pelanggan->files->count() }} File
                                                @foreach ($pelanggan->files as $file)
                                                    <br><a href="{{ asset('uploads/pelanggan/' . $file->filename) }}"
                                                        target="_blank" class="small">Lihat File</a>
                                                @endforeach
                                            </td>
                                            ...
                                            <td colspan="8" class="text-center py-4">
                                                <div class="text-muted">
                                                    ...
                                                    <a href="{{ route('pelanggan.create') }}"
                                                        class="btn btn-primary">Tambah Pelanggan Pertama</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
